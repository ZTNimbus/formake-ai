...
import FormBlocks from "./_common/FormBlocks";
...
function BuilderSidebar({ rest }: BuilderSidebarProps) {
    ...
    <Sidebar className="border-r left-12 pt-16" {...rest}>
      ...
      <SidebarContent className="pt-2 px-5 bg-white">
        <div className="w-full">
          <div className="w-full flex gap-1 h-[39px] rounded-full bg-gray-100 p-1">
            <button
              className={cn(
